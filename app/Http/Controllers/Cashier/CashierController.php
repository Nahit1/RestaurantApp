...
class CashierController extends Controller
{
    ...
    public function getSaleDetailsByTable($table_id){
        ...
        if($sale){
            ...
            $html .= 'Not found any sale detail';
        }
    ...
    private function getSaleDetails($sale_id){
        ...
        if($showBtnPayment){
            $html .= '<button data-id="'.$sale_id.'" data-totalAmount="'.$sale->total_price.'" class="btn btn-success btn-block btn-payment" data-toggle="modal" data-target="#staticBackdrop">Payment</button>';
        }else{
